...
import { Stat, StatLabel, StatNumber, StatGroup, Box, Button, useDisclosure, FormControl, FormLabel } from "@chakra-ui/core";
import {Popover, PopoverTrigger,  PopoverContent,PopoverHeader,  PopoverBody,  PopoverArrow,  PopoverCloseButton, useToast } from "@chakra-ui/core";
import {Accordion, AccordionItem, AccordionHeader, AccordionPanel, AccordionIcon } from "@chakra-ui/core";
import {Modal, ModalOverlay, ModalContent, ModalHeader, ModalFooter, ModalBody, Textarea } from "@chakra-ui/core";
...
<Grid container spacing={2}>
  ...
  <AccordionItem>
    ...
    <AccordionPanel pb={4}>
    <Button onClick={onOpen} leftIcon='edit' variantColor="pink" variant="solid">
    Request
  ...
  <AccordionItem>
    ...
    <Link color='purple' to="./Lease.pdf" target="_blank" download>Download</Link>
...
<Popover>
<PopoverTrigger>
<Button onClick={() => handleClick()} leftIcon="edit" variantColor="pink" variant={button}>
          Submit!
        </Button>
</PopoverTrigger>
